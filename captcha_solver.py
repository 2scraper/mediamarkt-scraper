...
page. If MediaMarkt renders a reCAPTCHA v3 challenge anywhere — account,
newsletter and checkout flows are the usual places — this fires.
...
# of it is ported here, because MediaMarkt has no such page.
#
# What MediaMarkt does instead is answer HTTP 403 with its ordinary branded
